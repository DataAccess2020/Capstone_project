...
For what concerns the dataset with all parliamentary interventions of 2015, I went through the same operations as those explained above for dates and parliamentary group, then I recoded the variable `argomento` because I needed it to become a dummy: 1 if the deputy told about women, 0 if he/she didn't.
...
```{r, out.width = '85%', fig.align = 'center', fig.cap = 'Gender equality in Italian parliament, XVII legislature', message = F, echo = F}
...
propt17 %>%  
  ...
  labs(title = "How much men and women deputies told about gender equality during the XVII legislature",
