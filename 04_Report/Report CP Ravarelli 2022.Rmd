...
```{r, out.width = '75%', fig.align = 'center', fig.cap = 'Most common bigrams containing the word "donna/e", XVII legislature', message = F, echo = F}
bigrams_count %>%
...
```{r, out.width = '75%', fig.align = 'center', fig.cap = 'How much men and women deputies told about gender equality during the XVII legislature', message = F, echo = F}
...
Secondly, this analysis relies on a strong assumption according to which mentioning the word "donne" means talking about women rights and/or gender equality. It comes without saying that this is not always true. To try reducing the possibility of including intervention which were not relevant for the analysis, I decided to carry out text mining. However, the most common bigram turned out to be 'donne audizione', which, as already mentioned, does not provide the anylisis with a useful information about the precise scope whithin which the word "donne" was mentioned. 
