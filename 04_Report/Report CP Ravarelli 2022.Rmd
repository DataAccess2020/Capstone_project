...
"SELECT DISTINCT ?argomento ?nome ?cognome ?genere ?dataNascita ?gruppo_parlamentare 
                 ?background ?inizioIncarico ?fineIncarico ?data_intervento 
...
- Analogously, but for a different reason, deputies belonging to the mixed group were not assigend to a different category.
