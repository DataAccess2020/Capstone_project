...
##Italian deputies who spoke about gender equality in the 
##Chamber of Deputies during the XVII legislature------------

data17 <- SPARQL(url="http://dati.camera.it/sparql", query=
...
#All interventions in 2015, during Renzi govern--------
...
query_offset <- c("0","5000","10000", "15000", "20000", "25000", 
